...
| `MCP_PRINTER_CONFIRM_IF_OVER_PAGES`    | `10`                                      | If set > 0, print jobs exceeding this many physical sheets will trigger a confirmation prompt from the AI before printing. Set to `0` to disable. |
